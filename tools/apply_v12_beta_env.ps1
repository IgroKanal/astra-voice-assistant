...
# ASTRA_YANDEX_MUSIC_PATH is intentionally not written here. Automatic
# resolution is the default, and an existing user override must be preserved.
[System.IO.File]::WriteAllLines($EnvPath, $Lines.ToArray(), $Utf8)
Write-Host "Astra v1.2 Beta environment settings applied to .env"
